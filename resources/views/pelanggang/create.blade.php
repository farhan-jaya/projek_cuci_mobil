                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Pelanggang</h6>
                            <hr />
                            <form action="{{ route('pelanggang.store') }}" method="POST">
                            @csrf
                                <div class="row mb-3">
                                    <div class="col">
                                ...
                                <div class="row mb-3">
                                    <div class="col">
                                        <input type="text" name="no_plat" class="form-control" placeholder="Nomor Plat">
                                    </div>
                                </div>
                                <div class="row mb-3">
